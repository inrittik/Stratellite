...
const ContactCard: React.FC<ContactCardProps> = ({
  ...
  return (
    <div className="flex p-3 py-4 border border-gray-500 rounded w-full my-3">
      <div className="flex w-1/4 border-r border-gray-500">
        <img
      ...
      <div className="flex flex-col w-1/4 border-r border-gray-500 px-3">
        <div className="font-semibold text-base">{companyName}</div>
        <div className="text-xs">Company Name</div>
      </div>

      <div className="flex flex-col w-1/4 border-r border-gray-500 px-3">
        <div className="font-semibold text-sky-400 text-base">{email}</div>
        <div className="text-xs">Email Address</div>
      </div>

      <div className="flex flex-col w-1/4 border-r border-gray-500 px-3">
        <div className="font-semibold text-base">{phoneNo}</div>
        <div className="text-xs">Phone Number</div>
      </div>

      <div className="border-l border-gray-500 px-3">
