...
const PhotoGallery = () => {
  return (
    <div className="flex flex-col md:w-10/12 mt-6 md:mt-0 ml-6 md:ml-12 overflow-y-auto">
      ...
      <div className="flex flex-col items-center justify-center my-20 md:my-0">
        ...
        <div className="flex flex-col text-center items-center justify-center my-4">
          ...
          <div className="flex items-center w-fit h-fit py-3 px-2 mr-2 md:px-4 font-semibold border rounded border-sky-400 cursor-pointer text-center text-sky-400 my-3 md:mr-0">
            Upload Images
          </div>
        </div>
      </div>
