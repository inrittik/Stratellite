...
const ActiveProjectCard: React.FC<ActiveProjectCardsProps> = ({ status }) => {
  return (
    <div className="w-full py-5 px-0 md:px-5 my-2 flex flex-col justify-between items-center rounded-lg border border-gray-60 md:flex-row mx-auto md:mx-auto">
      {/* section 1 */}
