  ...
  return (
    <div className="project overflow-y-auto overflow-x-hidden mx-auto">
      ...
      <div className="flex flex-col-reverse md:flex-row">
        {/* main section */}
        <div className="flex flex-col w-10/12 mt-6 md:mt-0 ml-6 md:ml-12 overflow-y-auto">
          {/* image section */}
          <div className="auto-cols-80% md:auto-cols-33% gap-3 grid grid-flow-col grid-cols overflow-auto pb-4 mb-10">
            <img src={Proprty1} alt="" className="h-72 mx-4" />
            <img src={Proprty2} alt="" className="h-72 mx-4" />
            <img src={Proprty1} alt="" className="h-72 mx-4" />
          </div>
          ...
          {/* project description */}
          <div className="flex flex-col w-full px-4 md:px-0 mt-6">
            <div className="my-3 font-semibold">About Project</div>
          ...
          {/* property info */}
          <div className="flex flex-col w-full px-4 md:px-0 mt-6">
            <div className="my-3 font-semibold">Property Info</div>
            <div className="flex w-fit justify-between items-center px-6 py-2 border border-gray-300 rounded-lg">
          ...
          <div className="mr-2 mt-8">{icons.Projects.units}</div>

          {/* scope of work */}
          <div className="flex flex-col w-full px-4 md:px-0 mt-3">
            <div className="my-3 font-semibold">Scope of Work</div>
          ...
          {/* tags */}
          <div className="flex flex-col w-full px-4 md:px-0 mt-6">
            <div className="my-3 font-semibold">Tags</div>
            <div className="flex">
              <div className=" flex items-center justify-evenly py-3 bg-gray-300 rounded-md cursor-pointer text-sm w-11/12 md:w-16 text-center my-3 mr-3">
                Tag1
              </div>
              <div className=" flex items-center justify-evenly py-3 bg-gray-300 rounded-md  cursor-pointer text-sm w-11/12 md:w-16 text-center my-3 mx-3">
                Tag2
              </div>
              <div className=" flex items-center justify-evenly py-3 bg-gray-300 rounded-md  cursor-pointer text-sm w-11/12 md:w-16 text-center my-3 mx-3">
                Tag3
        ...
        {/* toggles */}
        <div className="flex md:flex-col w-20 items-center ml-12">
